...
public enum Role implements GrantedAuthority {
    ...
    ROLE_PERMISSION_GROUP_WRITE("ROLE_PERMISSION_GROUP_WRITE"),
    ROLE_PERMISSION_GROUP_READ("ROLE_PERMISSION_GROUP_READ"),
    ROLE_PERMISSION_GROUP_DELETE("ROLE_PERMISSION_GROUP_DELETE"),
    ROLE_("ROLE_"),
    ;
